...
(/** @lends <global> */function( $ ) {
	...
	function _fnLanguageCompat( oLanguage )
	{
		...
		if ( !oLanguage.sEmptyTable && zeroRecords &&
			oDefaults.sEmptyTable === "il n'y a pas des utilisateurs" )
		{
	...
	DataTable.defaults = {
		 ...
		 * the page number, so if you have 10 enregistrements par page and want to start on
		...
		"oLanguage": {
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "emptyTable": "n'est pas d'Utilisateurs"
			 *        }
			 *      } );
			 *    } );
			 */
			"sEmptyTable": "N'a pas d'Utilisateurs",
			 ...
			 *    } );
			 */
			"sInfo": "Affichage de la page _PAGE_ de _PAGES_",
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoFiltered": " - filtrage à partir de _MAX_ enregistrements"
			 *        }
			 *      } );
			 *    } );
			 */
			"sInfoFiltered": "(- filtrage à partir de _MAX_ enregistrements)",
			 ...
			 *      $('#example').dataTable( {
			 *        "language": {
			 *          "infoPostFix": "Tous les enregistrements affichés sont dérivés d'informations réelles."
			 *        }
			 *      } );
			 *    } );
			 */
		 ...
		 *    $(document).ready( function() {
		 *      $('#example').dataTable( {
		 *        "search": {"recherche": "Initial search"}
		 *      } );
		 *    } )
		 */
